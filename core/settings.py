...
SECRET_KEY = 'django-insecure-q+p_a*tf@4r8ky*))t_wu%6-fooe=x0^k#r1e&qdxw0g8+#g30'
...
INSTALLED_APPS = [
    ...
    'django.contrib.gis',  # GeoDjango - MUST BE INCLUDED
    'rest_framework',
    'rest_framework_gis',
    'corsheaders',
...
MIDDLEWARE = [
    ...
    'customAuth.middleware.JWTAuthenticationMiddleware',  # Your custom middleware - RUNS AFTER built-in
...
DATABASES = {
    'default': {
        ...
        'NAME': 'su_v4_sa',      # Your DB name
        'USER': 'postgres',     # Your DB user
        'PASSWORD': 'scpl@123', # Your DB password
        'HOST': '192.168.0.217', # Your DB host, e.g., 'localhost' or an IP address
        'PORT': '5432',
    }
}
